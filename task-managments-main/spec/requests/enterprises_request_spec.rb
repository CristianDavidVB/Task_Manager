...
RSpec.describe "Enterprises Request", type: :request do
  ...
  describe "GET /api/v1/enterprises/:params" do
  ...
  describe "PUT /api/v1/enterprises/:id" do
  ...
  describe "PUT /api/v1/enterprises/:id/update_enabled" do
    before { put "/api/v1/enterprises/#{enterprise_id}/update_enabled", headers: headers }
